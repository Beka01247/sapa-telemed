...
export const organizations: Organization[] = [
    ...
    { site_name: 'AL08', commercial_name: 'ГКП на ПХВ "Талгарская ЦРБ"', region_id: 3 },
    ...
    { site_name: 'AQM02', commercial_name: 'ГКП на ПХВ "Шортандинская РБ" при УЗ Акмолинской области', region_id: 1 },
    { site_name: 'AQM03', commercial_name: 'ГКП на ПХВ "Егиндыкольская РБ" при УЗ Акмолинской области', region_id: 1 },
    ...
    { site_name: 'ATY03', commercial_name: 'КГП на ПХВ "Индерская районнная больница" УЗ АО', region_id: 4 },
    ...
    { site_name: 'MAN02', commercial_name: 'ГКП на ПХВ "Мангистауская центральная районная больница"', region_id: 10 },
    { site_name: 'MAN03', commercial_name: 'ГКП на ПХВ "Бейнеуская МЦРБ"', region_id: 10 },
    { site_name: 'AQTGP2', commercial_name: 'ГКП на ПХВ "Актауская городская поликлиника №2"', region_id: 10 },
    ...
    { site_name: 'TUR3', commercial_name: 'ГКП на ПХВ "Арысская центральная районная больница" УЗ ТО', region_id: 17 },
    { site_name: 'TUR4', commercial_name: 'ГКП на ПХВ "Ордабасинская центральная районная больница" УЗ ТО', region_id: 17 },
    { site_name: 'TUR5', commercial_name: 'ГКП на ПХВ "Тюлькубасская центральная районная больница" УЗ ТО', region_id: 17 },
    { site_name: 'TUR6', commercial_name: 'ГКП на ПХВ "Толебийская районная больница" УЗ ТО', region_id: 17 },
    { site_name: 'TUR7', commercial_name: 'ГКП на ПХВ "Келесская районная больница "Абай" УЗ ТО', region_id: 17 },
    { site_name: 'TUR8', commercial_name: 'ГКП на ПХВ "Казыгуртская центральная районная больница" УЗ ТО', region_id: 17 },
    { site_name: 'TUR9', commercial_name: 'ГКП на ПХВ "Центральная районная больница Байдибек" УЗ ТО', region_id: 17 },
    { site_name: 'TUR10', commercial_name: 'ГКП на ПХВ "Сайрамская центральная районная больница" УЗ ТО', region_id: 17 },
    { site_name: 'TUR11', commercial_name: 'ГКП на ПХВ "Отрарская центральная районная больница" УЗ ТО', region_id: 17 },
    { site_name: 'TUR12', commercial_name: 'ГКП на ПХВ "Районная поликлиника Сауран" УЗ ТО', region_id: 17 },
    { site_name: 'TUR13', commercial_name: 'ГКП на ПХВ "Сузакская центральная районная больница" УЗ ТО', region_id: 17 },
    { site_name: 'TUR14', commercial_name: 'ГКП на ПХВ "Мактааральская районная больница "Мырзакент" УЗ ТО', region_id: 17 },
